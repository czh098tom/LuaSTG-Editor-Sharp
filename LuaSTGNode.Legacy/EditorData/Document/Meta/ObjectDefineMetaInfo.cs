...
{
    public class ObjectDefineMetaInfo : MetaInfoWithDifficulty, IComparable<ObjectDefineMetaInfo>
    {
        ...
        public override MetaModel GetFullMetaModel()
        {
            ...
            {
                Icon = "/LuaSTGNode.Legacy;component/images/16x16/objectdefine.png",
                Text = Name
            };
