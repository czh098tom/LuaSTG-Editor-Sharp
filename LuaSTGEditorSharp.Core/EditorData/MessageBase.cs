    ...
    public abstract class MessageBase : ICloneable
    {
        ...
        public string Icon
        {
            get
            {
                if (WarningLevel < 1) 
                {
                    return "/LuaSTGEditorSharp.Core;component/images/error.png";
                }
                else if (WarningLevel > 5)
                {
                    return "/LuaSTGEditorSharp.Core;component/images/info.png";
                }
                else
                {
                    return "/LuaSTGEditorSharp.Core;component/images/warning.png";
                }
            }
        }
