...
{
    /// <summary>
    /// <see cref="Command"/> that insert a <see cref="TreeNodeBase"/> before a <see cref="TreeNodeBase"/>.
    /// </summary>
    public class InsertBeforeCommand : InsertCommand
    {
        ...
        public InsertBeforeCommand(TreeNodeBase toOp, TreeNodeBase toIns) : base(toOp, toIns) { }
